...
export default function Home() {
  ...
  return <main className={`voting-shell ${player ? "with-player" : ""}`} dir="rtl">
    ...
    <section className="hero"><p className="kicker">הקול שלכם קובע</p><h1>מצעד האלבומים | 25 שנות מוזיקה</h1><p>הצביעו לאלבומים, לשירים ולזמרים האהובים עליכם.</p></section>
